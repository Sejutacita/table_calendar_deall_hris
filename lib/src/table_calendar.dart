...
// ignore_for_file: prefer_asserts_with_message, avoid_bool_literals_in_conditional_expressions
  ...
  Future<void> _onDayTapped(DateTime day) async {
    ...
    if (_isRangeSelectionOn && widget.onRangeSelected != null) {
      if (_firstSelectedDay == null) {
        ...
        if (day.isAfter(_firstSelectedDay!) || day == _firstSelectedDay!) {
          widget.onRangeSelected!(_firstSelectedDay, day, _focusedDay.value);
          _firstSelectedDay = null;
    ...
    final isNextMonth = day.month > _focusedDay.value.month;
    final isPreviousMonth = day.month < _focusedDay.value.month;
        ...
        Flexible(
          ...
          child: TableCalendarBase(
            ...
            weekNumberBuilder: (BuildContext context, DateTime day) {
              ...
              var cell = widget.calendarBuilders.weekNumberBuilder
              ...
              if (dowCell == null) {
                ...
                dowCell = Center(
                  child: ExcludeSemantics(
                    child: Text(
                      widget.daysOfWeekStyle.isUpperCase
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        var rangeHighlight = widget.calendarBuilders.rangeHighlightBuilder
